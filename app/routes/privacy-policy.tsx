...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
    ...
    return [
        ...
        { property: "title", content: t("meta.privacy.title") },
        { property: "og:description", content: t("meta.privacy.description") },
        ...
        { property: "twitter:title", content: t("meta.privacy.title") },
        { property: "twitter:description", content: t("meta.privacy.description") },
