    ...
    if (c2) {
      ...
      if (r2) {
        t: {
          ...
          if (o2)
            for (let t3 in o2)
              isNaN(+t3) ? (s2 ??= {})[t3] = o2[t3] : (r2 = o2[t3], Array.isArray(r2) && (ft(r2) || ct(r2) && 0 === r2.size) && (r2 = null), null == r2 && (a2 = true), null != r2 && ((s2 ??= {})[t3] = r2));
          if (a2 || (s2 = o2), s2)
            for (let t3 in s2) {
              a2 = s2;
              break t;
...
//# sourceMappingURL=/build/_shared/vision_bundle-HLVSHHQY.js.map
